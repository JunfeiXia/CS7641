...
def plot_helper(x_axis, y_axis, label):
    ...
    # print('xaxis: ' + str(x_axis))
    # print('yaxis: ' + str(y_axis))
    # print('ymean: ' + str(y_mean))
    # print('ystd: ' + str(y_std))
...
def time_callback(iteration, attempt=None, done=None, state=None, fitness=None, curve=None, user_data=None, fitness_evaluations=None):
