...
from mlrose_hiive.fitness import TravellingSales, FlipFlop, FourPeaks
...
def load_dataset(split_percentage=0.2):
    ...
    x, y, labels, features = Dataset['data'], Dataset['target'], Dataset['target_names'], Dataset['feature_names']
...
def flip_plop(length, random_seeds):
    ...
    ro.plot_optimizations(problem=problem,
                          ...
                          plot_name='Flip Flop', plot_ylabel='Best Fitness')
    ...
    ro.plot_performances(problem=problem,
                         ...
                         plot_name='Flip Flop', plot_ylabel='Function Evaluation(Number of fitness evaluations)')
...
def four_peaks(length, random_seeds):
    ...
    ro.plot_optimizations(problem=problem,
                          ...
                          plot_name='Four Peaks', plot_ylabel='Best Fitness')
    ...
    ro.plot_performances(problem=problem,
                         ...
                         plot_name='Four Peaks', plot_ylabel='Function Evaluation(Number of fitness evaluations)')
...
def travel_salesman(length, distances, random_seeds):
    ...
    ro.plot_optimizations(problem=problem,
                          ...
                          pop_sizes=np.arange(100, 1001, 100), keep_pcts=np.arange(0.1, 0.81, 0.1),
                          plot_name='TSP', plot_ylabel='Best Fitness')
    ...
    ro.plot_performances(problem=problem,
                         ...
                         plot_name='TSP',
                         plot_ylabel='Function Evaluation(Number of fitness evaluations)'
                         # plot_ylabel = 'Fitness Value'
                         )
