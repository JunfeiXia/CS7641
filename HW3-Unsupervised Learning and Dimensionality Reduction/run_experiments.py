...
def load_dataset(dataset='WDBC', split_percentage=0.2):
    ...
    if dataset == datasets[0]:
        ...
        x, _, y, _ = train_test_split(x, y, test_size=0.80, shuffle=True, random_state=42, stratify=y)
...
if __name__ == '__main__':
    ...
    x_pca, x_ica, x_kpca, x_rp = dimensionality_reduction(x_train, x_test, y_train,
                                                          dataset=dataset,
                                                          pca_n_components=260, pca_kmeans_n_clusters=10,
                                                          pca_em_n_clusters=10, pca_em_covariance='full',
                                                          ica_n_components=320, ica_kmeans_n_clusters=10,
                                                          ica_em_n_clusters=10, ica_em_covariance='diag',
                                                          kpca_n_components=260, kpca_kernel='cosine',
                                                          kpca_kmeans_n_clusters=10,
                                                          kpca_em_n_clusters=10, kpca_em_covariance='full',
                                                          rp_n_components=500, rp_kmeans_n_clusters=10,
                                                          rp_em_n_clusters=10, rp_em_covariance='tied',
                                                          perform_model_complexity=perform_model_complexity)
